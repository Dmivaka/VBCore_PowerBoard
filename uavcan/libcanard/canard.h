...
///     - The received frame is not a valid Cyphal/CAN transport frame. - pass up
///     - The received frame is a valid Cyphal/CAN transport frame, but there is no matching subscription, - pass up
///       the frame did not complete a transfer, - hold
///       the frame forms an invalid frame sequence, - pass up
///       the frame is a duplicate, - pass up
///       the frame is unicast to a different node (address mismatch). - pass up
